    ...
    def send_divert_flowrule(self, msg):
        ...
        if pkt_tcp:
            ...
            match = parser.OFPMatch(eth_src=mac_src,
                                    eth_type=0x0800, ipv4_dst=pkt_ipv4.dst, ipv4_src="10.0.0.1",
            ...
            match = parser.OFPMatch(eth_src=mac_src,
                                    eth_type=eth_type, ipv4_dst=pkt_ipv4.dst, ipv4_src="10.0.0.1",
            ...
            priority = 100
            #actions = [parser.OFPActionOutput(out_port)]
            #actions -modify packet header to change destination addr
            action_modify_headers = [parser.OFPActionSetField(eth_dst="08:00:27:13:98:c5"),
            parser.OFPActionSetField(ipv4_dst="192.168.1.4"), parser.OFPActionOutput(2)]
